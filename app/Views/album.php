    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="<?= base_url('home/album') ?>">Data Album</a></div>
            </div>
        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" 
                                                    ...
                                                    data-nama_album="<?= $album->nama_album ?>"
                                                    data-deskripsi="<?= $album->deskripsi ?>"
                                                    data-tanggal_dibuat="<?= $album->tanggal_dibuat ?>">
                                                <i class="fas fa-pencil-alt"></i>
                                            </button>
                                            
                                            <a href="<?= base_url('home/hapus_album/'.$album->id_album) ?>" 
