<div class="main-content">
    <section class="section">
        <div class="section-header">
            ...
            <h1>Data Restore Edit Album</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="<?= base_url('home/dashboard') ?>">Dashboard</a></div>
                <div class="breadcrumb-item active"><a href="<?= base_url('home/restore_edit_album') ?>">Data Restore Edit Album</a></div>
            </div>
        </div>
                            ...
                            <tbody id="tableBody"> 
                                ...
                                ?>                          
                                    <tr>
                                        ...
                                        <a href="<?= base_url('home/restore_data_edit_album/'.$album->id_album) ?>" 
